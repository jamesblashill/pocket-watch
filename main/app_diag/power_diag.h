 ...
 *        by USB bus power or battery charging. Temporary instrumentation
 *        for the BATTERY_OPTIMIZATIONS.md investigation - not meant to
 *        ship long-term. Call after msg_driver_init() (owns the bq27220
